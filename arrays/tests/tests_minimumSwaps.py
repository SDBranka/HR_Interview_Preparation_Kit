...
import sys
sys.path.append("..")
from arrays import minimumSwaps


class test_minimumSwaps(unittest.TestCase):
    def testExample(self):
        arr = [7, 1, 3, 2, 4, 5, 6]
        self.assertEqual(minimumSwaps(arr), 5)

    def testSample0(self):
        arr = [4, 3, 1, 2]
        self.assertEqual(minimumSwaps(arr), 3)
...
# After swapping (1, 2) we get ae = [1, 4, 3, 2]
